function getInputValue(){
    ...
    if(inputVal==1){
        document.getElementById("demo").innerHTML ="Swastikraj Pradhan";
        document.getElementById("demo1").innerHTML ="10000";
    }
    else if(inputVal==2)
    {
        document.getElementById("demo").innerHTML ="Harshad";
        document.getElementById("demo1").innerHTML ="0";  
    }
    else if(inputVal==3)
    {
        document.getElementById("demo").innerHTML ="Rajesh";
        document.getElementById("demo1").innerHTML ="10000";   
    }

    else if(inputVal==4)
    {
        document.getElementById("demo").innerHTML ="Soumya";
        document.getElementById("demo1").innerHTML ="10000";   
    }
    else if(inputVal==5)
    {
